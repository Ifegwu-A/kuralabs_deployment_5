...
resource "aws_ecs_task_definition" "aws-ecs-task" {
  ...
  {
      "name": "url-container",
      "image": "finalboss360/urlshortner:latest",
      "logConfiguration": {
        "logDriver": "awslogs",
        "options": {
  ...
  memory                   = "1024"
  cpu                      = "512"
  execution_role_arn       = "arn:aws:iam::790604013354:role/ecsTaskExecutionRole"
  task_role_arn            = "arn:aws:iam::790604013354:role/ecsTaskExecutionRole"
